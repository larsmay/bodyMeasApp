...
app.intent("userRequestsHeart", (conv) => {
    ...
    if(!age){
        ...
        message = `Based on previously supplied values your Zone 1 range is ${heart1} to ${heart2}. Your Zone 2 range is ${heart2} to ${heart3}. Your Zone 3 range is ${heart3} and greater. Would you like to know your bmi or body fat percentage?`;
...
app.intent("heartRate",(conv) => {
    ...
    message = `Your Zone 1 range is ${heart1} to ${heart2}. Your Zone 2 range is ${heart2} to ${heart3}. Your Zone 3 range is ${heart3} and greater. Would you like to know your bmi or body fat percentage?`;
...
app.intent("userRequestsBodyFat", (conv) => {
    ...
    if (!age && !gender) {
        ...
        message = `Based on previously entered values your Body Fat percentage is ${bodyPercent} percent.  Would you like to know your bmi or target heart rate?`;
    ...
    app.intent("body_fat", (conv) => {
        ...
        var message = `Your Body Fat percentage is ${bodyPercent} percent.  Would you like to know your bmi or target heart rate?`;
